...
// export const AddressDetails: React.FC<AddressDetailsProps> = ({ form }) => {
//   const {
//     register,
//     formState: { errors },
//     setValue,
...
//   // Watch the invitation token field if it exists in your schema
//   const currentToken = watch("invitation_token" as any) || invitationToken;

//   const generateAndCopyInvitationLink = useCallback(async () => {
//     // Generate UUID token
//     const newToken = generateUUID();
//     setInvitationToken(newToken);
    
//     // Set the token in the form if you have an invitation_token field
//     // Uncomment this if you have invitation_token in your schema
//     // setValue("invitation_token" as any, newToken);
    
//     // Create the invitation link (adjust the base URL as needed)
//     const baseUrl = window.location.origin;
//     const invitationLink = `${baseUrl}/invite?token=${newToken}`;
...
//     if (isChecked && !invitationToken) {
//       generateAndCopyInvitationLink();
//     }
//   };
...
//                   value={invitationToken ? `${window.location.origin}/invite?token=${invitationToken}` : ""}
//                   readOnly
...
//               <button
//                 type="button"
//                 onClick={generateAndCopyInvitationLink}
...
//                 }`}
//                 style={{ height: '42px', marginTop: '24px', background: '#026770' }} // Align with input field
...
//             {/* Hidden input to store the token for API submission */}
//             <input
//               type="hidden"
//               value={invitationToken}
//               {...register("invitation_token" as any)}
//             />
