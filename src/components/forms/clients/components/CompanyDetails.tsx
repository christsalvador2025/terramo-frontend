...
// import { TRegisterClientSchema } from "@/lib/validations/clientSchema";
...
// // import { useUploadClientPhotoMutation } from "@/store/api/clientApiSlice";
// import { useUploadClientPhotoMutation } from "@/lib/redux/features/clients/_clientApiSlice";
// import { toast } from "react-toastify";

// interface CompanyDetailsProps {
//   form: UseFormReturn<TRegisterClientSchema>;
// }
...
//   const [uploadPhoto, { isLoading: isUploading }] = useUploadClientPhotoMutation();
//   const [selectedFile, setSelectedFile] = useState<File | null>(null);

//   const handleFileUpload = async (file: File | null) => {
//     if (!file) {
//       setSelectedFile(null);
//       setValue("company_photo", "");
//       return;
//     }
...
//       setValue("company_photo", result.url);
...
//           placeholder={isUploading ? "Uploading..." : "Search files"}
//           error={errors.company_photo?.message}
//         />
//       </div>
